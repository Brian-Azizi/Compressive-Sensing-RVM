...
int blockResolution = 128; //define the dimension of the signal patches used - higher the better accuracy, but longer computational time
double init_noiseStd = 1;
int percentage = 50; //define the percentage of original measurements to be sensed
...
bool use_cascade = false; //set to true if intenting to use cascade, if using only one Discrete Cosine Transform dictionary set to FALSE;
