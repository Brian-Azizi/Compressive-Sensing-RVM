...
% top 4
  ...
  \draw (0,21) -- (1.5,22) -- (4.5,22) -- (3,21);
  \draw (4.5,22) -- (4.5,19) -- (3,18);
  
  \draw [<->] (6,21.5) -- (6,18) -- (9.5,18);
  \draw (6,18) rectangle (9,21);
  \draw (6,21) -- (7.5,22) -- (10.5,22) -- (9,21);
  \draw (10.5,22) -- (10.5,19) -- (9,18);

  \draw [<->] (0,15.5) -- (0,12) -- (3.5,12);
  \draw (0,12) rectangle (3,15);
  \draw (0,15) -- (1.5,16) -- (4.5,16) -- (3,15);
  \draw (4.5,16) -- (4.5,13) -- (3,12);

  \draw [<->] (6,15.5) -- (6,12) -- (9.5,12);
  \draw (6,12) rectangle (9,15);
  \draw (6,15) -- (7.5,16) -- (10.5,16) -- (9,15);
  \draw (10.5,16) -- (10.5,13) -- (9,12);
  
  \node at (1.5,18) [below] {$\phi(x,y,z)$};
  \node at (0,18) [left] {$0$};
  \node at (0,21) [left] {$1$};
  \node at (3,18) [below] {$1$};
  \node at (3.5,18) [below] {$x$};
  \node at (0,21.5) [left] {$y$};
  \node at (2.25,19.5) [above] {$z$};
  
  \node at (7.5,18) [below] {$\psi^H(x,y,z)$};
  \node at (6,18) [left] {$0$};
  \node at (6,21) [left] {$1$};
  \node at (9,18) [below] {$1$};
  ...
  \node at (1.5,12) [below] {$\psi^V(x,y,z)$};
  \node at (0,12) [left] {$0$};
  \node at (0,15) [left] {$1$};
  \node at (3,12) [below] {$1$};
  ...
  \node at (7.5,12) [below] {$\psi^D(x,y,z)$};
  \node at (6,12) [left] {$0$};
  \node at (6,15) [left] {$1$};
  \node at (9,12) [below] {$1$};
...
%bottom 4
  ...
  \draw (0,9) -- (1.5,10) -- (4.5,10) -- (3,9);
  \draw (4.5,10) -- (4.5,7) -- (3,6);
  
  \draw [<->] (6,9.5) -- (6,6) -- (9.5,6);
  \draw (6,6) rectangle (9,9);
  \draw (6,9) -- (7.5,10) -- (10.5,10) -- (9,9);
  \draw (10.5,10) -- (10.5,7) -- (9,6);

  \draw [<->] (0,3.5) -- (0,0) -- (3.5,0);
  \draw (0,0) rectangle (3,3);
  \draw (0,3) -- (1.5,4) -- (4.5,4) -- (3,3);
  \draw (4.5,4) -- (4.5,1) -- (3,0);

  \draw [<->] (6,3.5) -- (6,0) -- (9.5,0);
  \draw (6,0) rectangle (9,3);
  \draw (6,3) -- (7.5,4) -- (10.5,4) -- (9,3);
  \draw (10.5,4) -- (10.5,1) -- (9,0);
  
  \node at (1.5,6) [below] {$\psi^T(x,y,z)$};
  \node at (0,6) [left] {$0$};
  \node at (0,9) [left] {$1$};
  \node at (3,6) [below] {$1$};
  ...
  \node at (7.5,6) [below] {$\psi^{HT}(x,y,z)$};
  \node at (6,6) [left] {$0$};
  \node at (6,9) [left] {$1$};
  \node at (9,6) [below] {$1$};
  ...
  \node at (1.5,0) [below] {$\psi^{VT}(x,y,z)$};
  \node at (0,0) [left] {$0$};
  \node at (0,3) [left] {$1$};
  \node at (3,0) [below] {$1$};
  \node at (3.5,0) [below] {$x$};
  ...
  \node at (7.5,0) [below] {$\psi^{DT}(x,y,z)$};
  \node at (6,0) [left] {$0$};
  \node at (6,3) [left] {$1$};
  \node at (9,0) [below] {$1$};
  ...
  \draw [fill=black, fill opacity=0.8] (9,19.5) -- (10.5,20.5) -- (10.5,19) -- (9,18);
 
  % V
  \draw [fill=black, fill opacity=0.8] (1.5,12) rectangle (3,15);
  \draw [fill=black, fill opacity=0.8] (1.5,15) -- (3,16) -- (4.5,16) -- (4.5,13) -- (3,12) -- (3,15);

  %TD
  \draw [fill=black, fill opacity=0.8] (6,12) rectangle (7.5,13.5);
  \draw [fill=black, fill opacity=0.8] (7.5,13.5) rectangle (9,15);
  \draw [fill=black, fill opacity=0.8] (7.5,15) -- (9,16) -- (10.5,16) -- (10.5,14.5) -- (9,13.5) -- (9,15);
    
  % bottom
  % T
  \draw [fill=black, fill opacity=0.8] (0.75,9.5) -- (1.5,10) -- (4.5,10) -- (4.5,7) -- (3.75,6.5) -- (3.75,9.5) -- (0.75,9.5);
  %TH
  \draw [fill=black, fill opacity=0.8] (6,6) rectangle (9,7.5);
  \draw [fill=black, fill opacity=0.8] (6.75,9.5) -- (7.5,10) -- (10.5,10) -- (10.5,8.5) -- (9.75,8) -- (9.75,9.5) -- (6.75,9.5);
  \draw [fill=black, fill opacity=0.8] (9,7.5) -- (9.75,8) -- (9.75,6.5) -- (9,6);
  %TV
  \draw [fill=black, fill opacity=0.8] (1.5,0) rectangle (3,3);
  \draw [fill=black, fill opacity=0.8] (1.5,3) -- (2.25,3.5) -- (3.75,3.5) -- (3.75,0.5) -- (3,0) -- (3,3);
  \draw [fill=black, fill opacity=0.8] (0.75,3.5) -- (1.5,4) -- (3,4) -- (2.25,3.5);
  %TD
  \draw [fill=black, fill opacity=0.8] (6,0) rectangle (7.5,1.5);
  \draw [fill=black, fill opacity=0.8] (7.5,1.5) rectangle (9,3);
  \draw [fill=black, fill opacity=0.8] (7.5,3) -- (8.25,3.5) -- (9.75,3.5) -- (9.75,2) -- (9,1.5) -- (9,3);
  \draw [fill=black, fill opacity=0.8] (9.75,0.5) -- (9.75,2) -- (10.5,2.5) -- (10.5,1);
  \draw [fill=black, fill opacity=0.8] (6.75,3.5) -- (7.5,4) -- (9,4) -- (8.25,3.5);
\end{tikzpicture}
...
\label{fig:haar_3d}
\end{figure}
Figure \ref{fig:haar_3d} shows the 3-D Haar scaling and wavelet functions.
The basis functions can be formed by shifting and scaling these functions.
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \draw [thick] (6,3) -- (8,5);
    \draw [thick] (3,6) -- (5,8);
    \draw [dashed] (0,0) -- (2,2) -- (8,2);
    \draw [dashed] (2,2) -- (2,8);
    \draw [dashed] (1,1) -- (7,1);
    \draw [dashed] (0,3) -- (2,5) -- (8,5);
    \draw [dashed] (5,5) -- (3,3);
    \draw [dashed] (1,4) -- (7,4);
    \draw [dashed] (3,0) -- (5,2);
    \draw [dashed] (4,1) -- (4,7);
    %    \draw [dashed] (5,2) -- (5,8);
    \draw [dashed] (1,1) -- (1,7);
    %    \draw [fill=green, opacity=0.5] (3,0) -- (3,6) -- (5,8) -- (5,2);
    %    \draw [fill=blue, opacity=0.5] (0,3) -- (2,5) -- (8,5) -- (6,3);
    %   \draw [fill=orange, opacity=0.5] (1,1) -- (1,7) -- (7,7) -- (7,1);

    \node at (6,7.5) {\large$\bm{GGH}_1$};
    \node at (3,7.5) {\large$\bm{GHH}_1$};
    \node at (1.5,4.5) {\large$\bm{HHH}_1$};
    \node at (4.5,4.5) {\large$\bm{HGH}_1$};
    \node at (1.5,1.5) {\large$\bm{HHG}_1$};
    \node at (4.5,1.5) {\large$\bm{HGG}_1$};
    \node at (9,3.5) {\large$\bm{GGG}_1$};
  \end{tikzpicture}
\end{figure}
